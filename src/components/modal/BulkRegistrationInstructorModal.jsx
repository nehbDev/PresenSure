...
const BulkRegistrationInstructorModal = ({ isOpen, onClose, onSave }) => {
    ...
    >
      ...
      >
        ...
        <div className="bg-[#2D336B] flex justify-between items-center px-6 py-3 rounded-t-lg">
          <h2 className="text-xl font-bold text-white">Bulk Instructor Registration</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          <div className="flex flex-col gap-6">
            <div className="transition-all duration-300 ease-out transform hover:bg-gray-50 p-2 rounded-md">
              <label className="text-sm font-medium text-gray-700">Upload Instructor Data (CSV/Excel):</label>
              <div className="mt-2">
                <input
                  type="file"
                  accept=".csv, .xlsx"
              ...
              <p className="text-xs text-gray-500 mt-2">
                Please upload a file with columns: Instructor ID, First Name, Middle Initial, Last Name, Email, Password, Sex, Department, Role.
              </p>
            </div>
          </div>
        </form>
...
export default BulkRegistrationInstructorModal;