...
const ManualScheduleModal = ({ isOpen, onClose, onSave }) => {
  ...
  const filteredStudents = students.filter((student) => {
    ...
    const matchesYearLevel = filters.yearLevel ? student.yearLevel === filters.yearLevel : true;
    const matchesBlock = filters.block ? student.year_and_section === filters.block : true;
    const matchesDepartment = filters.department ? student.department === filters.department : true;
    return matchesSearch && matchesCourse && matchesYearLevel && matchesBlock && matchesDepartment;
  });
  ...
  const handleSelectAll = (e) => {
    ...
    setFormData((prev) => ({
      ...prev,
      students: checked ? filteredStudents.map((student) => student.studentId) : [],
    }));
  };
      ...
      name: (
        <input
          ...
          checked={
            ...
            filteredStudents.every((student) => formData.students.includes(student.studentId))
          }
  ...
  return (
    ...
    >
      ...
      >
        <div className="bg-[#059669] flex justify-between items-center px-4 py-2 rounded-t-lg">
          <h2 className="text-lg font-bold text-white">Add Schedule</h2>
        ...
        >
          <div className="flex flex-col gap-4">
            <div className="border-b border-gray-200 pb-1">
              <h3 className="text-base font-semibold text-gray-800">Schedule Details</h3>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                <div
                  key={field.name}
                  className={`transition-all duration-300 ease-out transform hover:bg-gray-50 p-1 rounded-md delay-${index * 100}`}
                >
            ...
            <div className="border-b border-gray-200 pb-1 mt-3">
              <h3 className="text-base font-semibold text-gray-800">Instructor Assignment</h3>
            </div>
            ...
            <div className="border-b border-gray-200 pb-1 mt-3">
              <h3 className="text-base font-semibold text-gray-800">Student Assignment</h3>
            </div>
            <div className="space-y-3">
              ...
              <div className="max-h-40 manual-schedule-table">
                <DataTable
                  columns={columns}
        ...
        <div className="flex justify-end gap-2 p-3 border-t border-gray-200">
          <button
            ...
            className="flex items-center bg-[#059669] border border-[#059669] px-2 py-1 text-xs text-white rounded-md hover:bg-[#047857] hover:border-[#047857] transition-all duration-300 hover:scale-95"
          >
            Save Schedule
          </button>
          <button
